...
import { deleteEmpresa, getEmpresasInactivas } from "../../services/empresas/empresas";
...
const EmpresasListInactive = () => {
    ...
    return (_jsxs("div", { className: "max-w-full flex flex-col items-center bg-gray-900 text-white p-15", children: [_jsxs("div", { className: "w-full flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-4", children: [_jsx("h1", { className: "text-2xl font-bold mb-4", children: "EMPRESAS INACTIVAS DEL SISTEMA" }), _jsx("input", { type: "text", value: searchQuery, onChange: (e) => setSearchQuery(e.target.value), placeholder: "Buscar por RUC o nombre", className: "mb-1 p-2 border rounded w-80 text-white" })] }), _jsx("div", { className: "w-full overflow-x-auto", children: _jsxs("table", { className: "w-full bg-gray-800 rounded-lg overflow-hidden", children: [_jsx("thead", { className: "bg-gray-700", children: _jsxs("tr", { className: "text-left", children: [_jsx("th", { className: "p-2", children: "Ruc" }), _jsx("th", { className: "p-2", children: "Nombre" }), _jsx("th", { className: "p-2", children: "Correo" }), _jsx("th", { className: "p-2", children: "Direccion" }), _jsx("th", { className: "p-2", children: "Telefono" }), _jsx("th", { className: "p-2", children: "Estado" }), _jsx("th", { className: "p-2", children: "Acciones" }), _jsx("th", { className: "p-2", children: "Update" })] }) }), _jsx("tbody", { children: empresas.map((empresa, index) => (_jsxs("tr", { className: "border-b border-gray-700", children: [_jsx("td", { className: "p-2 whitespace-nowrap", children: empresa.emp_ruc }), _jsx("td", { className: "p-2 whitespace-nowrap", children: empresa.emp_nombre }), _jsx("td", { className: "p-2 whitespace-nowrap", children: empresa.emp_correo }), _jsx("td", { className: "p-2 whitespace-nowrap", children: empresa.emp_direccion }), _jsx("td", { className: "p-2 whitespace-nowrap", children: empresa.emp_telefono }), _jsx("td", { className: "p-2 whitespace-nowrap", children: empresa.activo ? (_jsx("span", { className: "text-green-500", children: "Activo" })) : (_jsx("span", { className: "text-red-500", children: "Inactivo" })) }), _jsx("td", { className: "p-2 whitespace-nowrap", children: _jsx("button", { onClick: () => handleVerEmpresa(empresa.emp_id), className: "bg-blue-500 px-3 py-1 rounded-md hover:bg-blue-600", children: "\uD83D\uDD0E Ver" }) }), _jsx("td", { className: "p-2 whitespace-nowrap", children: _jsx("button", { onClick: () => updatedEmpresa(empresa.emp_id), className: "bg-orange-500 px-3 py-1 rounded-md hover:bg-orange-600", children: "\uD83D\uDCDD Modificar" }) })] }, empresa.emp_id))) })] }) })] }));
};

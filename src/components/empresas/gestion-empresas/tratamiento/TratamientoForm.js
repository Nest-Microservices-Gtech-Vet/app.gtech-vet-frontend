...
const TratamientoForm = ({ consultaId, mascotaId, empresaId, onSuccess }) => {
    ...
    return (_jsxs("div", { className: "bg-white rounded p-6 shadow", children: [_jsx("h3", { className: "text-xl font-semibold mb-4 text-gray-700", children: "\uD83D\uDC8A Tratamiento Prescrito" }), _jsx("p", { className: "mb-4 text-sm text-gray-600", children: "Registra los medicamentos para esta consulta." }), _jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4", children: [_jsx("div", { className: "bg-gray-white p-4 rounded-lg sm:col-span-1", children: _jsxs("div", { className: "relative w-full", children: [_jsx("input", { type: "text", id: "nombre", name: "nombre", value: medicamento.nombre, onChange: (e) => handleChange("nombre", e.target.value), placeholder: " ", className: "peer bg-transparent h-10 w-full rounded-lg text-black ring-2 px-2 ring-gray-500 focus:ring-sky-600 focus:outline-none" }), _jsx("label", { htmlFor: "nombre", className: "absolute left-2 top-2 bg-gray-50 px-1 text-gray-500 text-sm transition-all\r\n          peer-placeholder-shown:top-2\r\n          peer-placeholder-shown:text-base\r\n          peer-placeholder-shown:text-gray-400\r\n          peer-focus:-top-3\r\n          peer-focus:text-sm\r\n          peer-focus:text-sky-600", children: "Nombre del medicamento" })] }) }), _jsx("div", { className: "bg-gray-white p-4 rounded-lg sm:col-span-1", children: _jsxs("div", { className: "relative w-full", children: [_jsx("input", { type: "text", id: "dosis", name: "dosis", value: medicamento.dosis, onChange: (e) => handleChange("dosis", e.target.value), placeholder: "Dosis (Ej: 1 tab cada 12h por 5 d\u00EDas)", className: "peer bg-transparent h-10 w-full rounded-lg text-black ring-2 px-2 ring-gray-500 focus:ring-sky-600 focus:outline-none" }), _jsx("label", { htmlFor: "dosis", className: `absolute left-2 bg-gray-50 px-1 text-gray-500 transition-all peer-placeholder-shown:top-2 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:w-full peer-focus:-top-3 peer-focus:text-sm peer-focus:text-sky-600 peer-focus:w-auto peer-focus:bg-gray-50 -top-3 text-sm w-auto `, children: "Dosis" })] }) })] }), _jsx("div", { className: "flex gap-2 mb-6", children: _jsx("button", { type: "button", onClick: agregarMedicamento, className: "bg-gray-200 hover:bg-gray-300 px-4 py-2 rounded", children: "\u2795 Agregar a receta" }) }), listaMedicamentos.length > 0 && (_jsxs("div", { className: "mb-6", children: [_jsx("h4", { className: "text-md font-semibold mb-2 text-gray-700", children: "\uD83D\uDCCB Medicamentos en receta:" }), _jsx("ul", { className: "list-disc list-inside text-sm text-gray-800 space-y-1", children: listaMedicamentos.map((m, idx) => (_jsxs("li", { children: [_jsx("strong", { children: m.nombre }), " \u2013 ", m.dosis] }, idx))) })] })), _jsx("button", { type: "button", onClick: guardarTratamiento, className: "bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded", children: "\uD83D\uDCBE Guardar receta" })] }));
};

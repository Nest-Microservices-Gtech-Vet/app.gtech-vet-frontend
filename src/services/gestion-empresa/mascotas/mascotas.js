...
export const getMascotas = async (empresaId, search) => {
    try {
...
export async function updateMascota(mascotaId, formData) {
...
//     }
// };
export const crearMascota = async (formData) => {
...
export const removeMascota = async (mascotaId) => {
    try {
        const data = await apiFetch(`mascotas/${mascotaId}`, {
            method: "DELETE",
        });
